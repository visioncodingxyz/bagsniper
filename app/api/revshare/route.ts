...
export async function GET() {
  try {
    ...
    const tokenAddress = "AGo2mZNfN6P6PhXVUMNB4GUwJZpPrv2jGhbwgsLucTAX"
    ...
    const revshareData = {
      totalSolDistributed: totalSolDistributed || 7.5653,
      totalDistributions: totalDistributions || 79,
      minimumRequired: minimumRequired || 1000000,
      lastUpdated: new Date().toISOString(),
      dataSource: totalSolDistributed && totalDistributions ? "parsed" : "target_values",
    }
