...
export function NewReleasePromo() {
  return (
    <section className="mt-12 w-full mb-16">
      <div className="relative mx-auto max-w-4xl overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-b from-white/5 to-white/[0.02] p-10 shadow-[0px_2px_0px_0px_rgba(255,255,255,0.1)_inset]">
        ...
        <div className="relative z-10">
          <div className="mt-8 text-center">
            <div className="mb-6 flex justify-center">
              <div className="inline-flex items-center gap-2 px-6 py-3 text-lg font-bold bg-black text-white border border-gray-600 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 rounded-full">
                Snipe. Execute. Profit Instantly.
              </div>
            </div>
            <p className="text-white/60 mb-8">Lightning-fast trading on Solana.</p>
            <svg
              width="100"
              height="50"
              viewBox="0 0 100 50"
            ...
            <div className="flex items-center justify-center">
              <a href="https://t.me/BagSniperBot" target="_blank" rel="noopener noreferrer">
                <div className="group border-border bg-secondary/70 flex h-[64px] cursor-pointer items-center gap-2 rounded-full border p-[11px] mt-10">
                  <div className="border-border bg-gradient-to-r from-[#9945FF] to-[#14F195] flex h-[43px] items-center justify-center rounded-full border">
